...
function resume(){
 ...
 <object data={process.env.PUBLIC_URL+"/resume/Mathew Lundin Resume.pdf"} style={{height:'48rem', width:'100%'}}><div className="container"><h1 className="orange-text">Looks like your browser doesn't support PDF.<a href="./resume/Mathew Lundin Resume.pdf" download="Mathew Lundin Resume" className="waves-effect waves-light btn-large">Download Mat's Resume</a></h1><br></br><br></br></div></object>
        </>
    )
};
