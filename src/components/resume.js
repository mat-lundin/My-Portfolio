...
function resume(){
 ...
 <object data={process.env.PUBLIC_URL+"/resume/Mathew Lundin Resume.pdf"} style={{height:'40rem', width:'100%'}}>Please open in a desktop browser or install a PDF viewer to see my resume!</object>
        </>
    )
};
