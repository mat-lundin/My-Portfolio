...
function resume(){
 ...
 <object data={process.env.PUBLIC_URL+"/resume/Mathew Lundin Resume.pdf"} style={{height:'48rem', width:'100%'}}><div className="container"><h1 className="blue-text">Please open in a desktop browser or install a PDF viewer to see my resume!</h1><br></br><br></br></div></object>
        </>
    )
};
